...
export const SubnettingCalculator = ({ onStepChange }: SimulatorStepProps) => {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h2 className="text-xl font-bold text-foreground">Subnetting / CIDR Calculator</h2>
        <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1">
          Enter an IP and prefix to inspect network boundaries, host ranges, and binary splits.
        </p>
      </div>
